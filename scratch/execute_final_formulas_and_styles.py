...
# Load data_only=False workbook to write formulas and styles
...
print("Updating Master sheet with live Excel formulas and strict cell fills...")
...
print(f"Total DSW CRM rows updated with live formulas: 190")
...
if not saved:
    purple_temp_path = r"F:\印度洋测样\ODV\202608\20260824\Ocean_DOC_MultiColumn_QC_Report_GEOMAR_Validated_v2_Processed_latest_FORMULA_DSW.xlsx"
