...
src_path = r"F:\印度洋测样\ODV\202608\20260829\Ocean_DOC_MultiColumn_QC_Report_GEOMAR_Validated_v2 (14).xlsx"
dst_path = r"F:\印度洋测样\ODV\202608\20260829\Ocean_DOC_MultiColumn_QC_Report_GEOMAR_Validated_v2_Processed-20260829_Updated_ST51_ST21.xlsx"
out_path = r"F:\印度洋测样\ODV\202608\20260829\Ocean_DOC_MultiColumn_QC_Report_GEOMAR_Validated_v2_Processed-20260829_Final_QC_Completed.xlsx"

print(f"Loading Source (Web Export 14): {src_path}")
...
target_sample_ids = [d['sid'] for d in diffs_13_14]
target_rows = [d['row'] for d in diffs_13_14]
print(f"Target sample IDs count: {len(target_sample_ids)}")
...
flag4_fill = PatternFill(start_color="FEE2E2", end_color="FEE2E2", fill_type="solid")
flag4_font = Font(name="Segoe UI", size=9.5, bold=True, color="991B1B")
...
for r in range(6, ws_master_dst.max_row + 1):
    ...
    if sid in target_sample_ids or r in target_rows:
        # Injections
        for c in range(6, 10):
        ...
        if src_flag == 2:
            ...
            cell_flag.fill = flag4_fill
            cell_flag.font = flag4_font
        ...
        try:
            ...
            if s_data:
                ...
                if new_flag in (2, 3):
                    ...
                    ws_odv_dst.cell(r, 1).value = "被丢弃 / Discarded (Flag 4)"
