...
# Save to purple file first
wb_out.save(purple_file_path)
print(f"Successfully saved purple highlighted file to {purple_file_path}")

# Try copying/saving to original file path
try:
    shutil.copyfile(purple_file_path, file_path)
    print(f"Successfully copied to main file: {file_path}")
